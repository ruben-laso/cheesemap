# From https://github.com/PLplot/PLplot/blob/master/cmake/modules/FindShapelib.cmake
...
find_path(SHAPELIB_INCLUDE_DIR
        shapefil.h
        PATHS ${CMAKE_SOURCE_DIR}/lib/shapelib-1.5.0 /usr/local/include/shapelib-1.5.0)

if(SHAPELIB_INCLUDE_DIR)
  find_library(SHAPELIB_LIBRARY
          NAMES shp shapelib
          PATHS ${CMAKE_SOURCE_DIR}/lib/shapelib-1.5.0 /usr/local/lib
          )
  if(SHAPELIB_LIBRARY)
