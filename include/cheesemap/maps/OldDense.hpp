...
namespace chs
{
	...
	class OldDense
	{
		...
		OldDense(Points_rng & points, const resolution_type res, chs::flags::build::flags_t flags = {}) :
		        OldDense(points, dimensions_type{ n_tuple<Dim>(res) }, flags)
		{}

		template<ranges::range Points_rng> // requires to be sortable
		OldDense(Points_rng & points, dimensions_type res, chs::flags::build::flags_t flags = {}) :
