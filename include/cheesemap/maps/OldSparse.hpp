...
namespace chs
{
	...
	class OldSparse
	{
		...
		OldSparse(Points_rng & points, const resolution_type res, const chs::flags::build::flags_t flags = {}) :
		        OldSparse(points, dimensions_type(n_tuple<Dim>(res)), flags)
		{}

		template<typename Points_rng>
		OldSparse(Points_rng & points, dimensions_type res, const chs::flags::build::flags_t flags = {}) :
