#include <cheesemap/maps/Dense2D.hpp>
...
auto build_map = [](auto & points) { return chs::Dense2D<chs::Point>(points, CELL_SIZE, /* reorder = */ false); };
auto build_map_reorder = [](auto & points) {
	return chs::Dense2D<chs::Point>(points, CELL_SIZE, /* reorder = */ true);
};
