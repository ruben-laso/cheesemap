...
auto build_map         = [](auto & points) { return chs::Mixed<chs::Point, 2>(points, CELL_SIZE, FLAGS); };
auto build_map_reorder = [](auto & points) { return chs::Mixed<chs::Point, 2>(points, CELL_SIZE, REORDER_FLAGS); };
